...
AWS_ACCESS_KEY_ID=AKIAJMAEQRZSCGU3JZTA

# Your Amazon AWS secret access key.
AWS_SECRET_ACCESS_KEY=yOHJ/zL/w2fXK+ggoRiYWuMJVYA3dxabJ7QdOOJ2
...
# The download URL for the Sun JDK. Visit http://java.sun.com/javase/downloads/index.jsp and get the URL for the "Linux self-extracting file".
  ARCH='x86_64'
  BASE_AMI_IMAGE="ami-eda1e184"
  JAVA_BINARY_URL='http://54.225.231.9/jdk-7u17-linux-x64.tar.gz'
  AMI_KERNEL=aki-88aa75e1
  export AMPLE_HOME=/home/ubuntu/hadoop-ec2-scripts
#if [ "$INSTANCE_TYPE" == "m1.small" -o "$INSTANCE_TYPE" == "c1.medium" ]; then
 # ARCH='x86_64'
  #BASE_AMI_IMAGE="ami-943c7dfd"  # ec2-public-images/fedora-8-i386-base-v1.07.manifest.xml
  #JAVA_BINARY_URL='http://54.225.231.9/jdk-7u17-linux-x64.tar.gz'
#else
 # ARCH='x86_64'
  #BASE_AMI_IMAGE="ami-943c7dfd"  # ec2-public-images/fedora-8-x86_64-base-v1.07.manifest.xml
  #JAVA_BINARY_URL='http://54.225.231.9/jdk-7u17-linux-x64.tar.gz'
#fi

#if [ "$INSTANCE_TYPE" == "m1.small" ]; then
 # AMI_KERNEL=aki-88aa75e1 # ec2-public-images/vmlinuz-2.6.18-xenU-ec2-v1.0.i386.aki.manifest.xml
#fi

#if [ "$INSTANCE_TYPE" == "c1.xlarge" ]; then
 # AMI_KERNEL=aki-88aa75e1 # ec2-public-images/vmlinuz-2.6.18-xenU-ec2-v1.0.x86_64.aki.manifest.xml
#fi
